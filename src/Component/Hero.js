...
const Hero = () => {
    return (
        <div>
  <div className="herotext" style={{marginTop: 20}}>
    <h1 style={{fontWeight: 'bold', letterSpacing: 3, marginTop: 20, marginBottom: 10}}>Hey,Joyanta Here,Discovers my Stories and Creative Ideas!! </h1>
  </div>
  <div className="hero" style={{marginTop: 20}}>
    ...
    <div className="heroright">
      <h5>He's got good ago and four g ago ago and </h5>
